const Classes = [
  ...
  },
  {
    ...
    skills: ["Debugging", "Coding", "Command Line"],
    topics: [],
    content: ["Lectures"],
    rating: 3,
    enrolled: 150,
    classSize: 200,
    waitingList: 200,
    degrees: ["Robotics", "Computing Science"],
  ...
  },
  {
    ...
    skills: ["Command Line", "Coding", "Debugging"],
    topics: [],
    content: ["Discussion"],
    rating: 4,
    enrolled: 350,
  ...
  },
  {
    ...
    skills: ["Command Line", "Coding", "Algorithms"],
    topics: ["Mobile"],
    content: ["Discussion"],
    rating: 2,
    enrolled: 400,
  ...
  },
  {
    ...
    skills: ["Debugging", "Coding", "Algorithms"],
    topics: [],
    content: ["Discussion"],
    rating: 4,
    enrolled: 57,
    classSize: 50,
    waitingList: 50,
    degrees: ["Robotics", "Computing Science", "Machine Learning"],
  ...
  },
  {
    ...
    classSize: 100,
    waitingList: 50,
    degrees: ["Robotics", "Computer Interaction"],
  ...
  },
  {
    ...
    classSize: 400,
    waitingList: 200,
    degrees: ["Robotics", "Computing Science", "Computer Interaction", "Machine Learning", "Security"],
  ...
  },
  {
    ...
    skills: ["Writing", "Reading", "Coding"],
    topics: ["VR", "Mobile", "Gaming"],
  ...
  },
  {
    ...
    skills: ["Calculus", "Coding", "Algorithms", "Problem Solving"],
    topics: [],
    content: ["Individual Projects"],
    rating: 1,
    enrolled: 76,
  ...
  },
  {
    ...
    classSize: 200,
    waitingList: 100,
    degrees: ["Computing Science", "Computer Interaction"],
  ...
  },
  {
    ...
    classSize: 100,
    waitingList: 50,
    degrees: ["Computing Science", "Machine Learning"],
  ...
  },
  {
    ...
    skills: ["Reading", "Coding", "Algorithms", "Problem Solving"],
    topics: [],
    content: ["Individual Projects"],
    rating: 5,
    enrolled: 112,
  ...
  },
  {
    ...
    skills: ["Calculus", "Algebra", "Problem Solving"],
    topics: [],
    content: ["Individual Projects", "Lectures"],
    rating: 1,
    enrolled: 89,
    classSize: 200,
    waitingList: 50,
    degrees: ["Computer Interaction", "Machine Learning"],
